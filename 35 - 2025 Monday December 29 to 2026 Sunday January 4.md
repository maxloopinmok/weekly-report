...
- 11pm I read compiled news, and briefly read this:
    ...
    - 11.26pm payment received from elaine
- 12.25am I tried to quick create a epub reader, but it got too involved, and chatgpt failed.
    - 2.50am I resorted to gemini with android studio and it works, but only first page shows and screen cannot scroll.
- 3.30am eat supper, sleep.

### Wednesday (December 31) ()
- 10am eat light breakfast and lunch.
- 10.30am read a little more about android:
    - 2021 Android for Absolute Beginners
    - 2024 Kotlin Programming
- 11.45am thereabouts, start searching and trying android apps with read out loud function.
    - a good read out loud function is too difficult to implement through programming.
    - found ReadEra, PocketBook Reader or Evie (The eVoice book reader).
- 12.45pm record tasks, medicines.
    - 1.15pm ask chatgpt about EpubTimelineReader android program.
    - messaged pk about what both wants for calendars.
- 3pm thereabouts, sleep.
    - 2.30pm eat first dinner, wash up.
- 5pm thereabouts, print out kotlin code for EpubTimelineReader for offline review.
    - take photo of laptop desktop and messaged pk, and also uploaded to payhip.
- 5.45pm scrape stocks data and upload to payhip, and posted blog post.
    - 6.30pm to 7.30pm go out second dinner, come home, bath.
    - 9.25pm I briefly watched parts of today's news on CNA, and Channel 5, and parts of these:
        - https://www.youtube.com/watch?v=XxsDlctCS1Y
        - https://www.youtube.com/watch?v=z2MUcmJS3aI
        - watch out for these two readings:
            - https://musemancer.com/aibw/
            - https://www.physicalrobotics.com/
- 12.40pm eat supper, sleep.

### Thursday (January 1) (bowels)
- 9am thereabouts, eat light breakfast, sleep.
- 12pm thereabouts, bath, eat lunch.
- 12.30pm I briefly read and compiled parts of yesterday's news.
- 2.45pm eat first dinner.
- 3pm do elaine's work.
    - send WhatsApp messages from elaine to clients for happy new year 2026.
- 6.10pm eat first supper, record tasks, medicines, plans.
...
- I searched for jobs.
- I reviewed selected books for further readings.
- I stabilised on a few books, read and blog them.
