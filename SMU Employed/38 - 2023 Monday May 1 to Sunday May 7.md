As of the Monday 12.45am that is past this week, I have worked on the following:
...
Actions:
- In progress.
- There was no Mirdin lecture on Monday because it was Labour Day.
- I tried to do some learning summaries until Unit 3, but not completing it.
- I completed the first two questions from Unit 6 homework.
- Some relevant links:
...
Actions:
- In progress.
- As suggested by a colleague, I've stopped attending this, but I'll be learning from the videos, notes and exercises at my own time.
